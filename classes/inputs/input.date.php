	...
	private function get_settings() {
		...
		$input_meta = array(
			...
			'year_range'        => array(
				...
				'desc'        => __( '[ jQuery datePicker ] Years to allow date selections. Example: c-10:c+10. TIP: The letter `c` indicates the current year so `c+1` will indicate next year.  Thus c:c+1 will be ' . date( 'Y' ) . ':' . date( 'Y', strtotime( '+1 year' ) ), 'woocommerce-product-addon' ),
