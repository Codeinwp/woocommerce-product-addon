...
final class Settings {
	 ...
	 */
	public static function get_plugin_meta(): array {
	 ...
	 */
	public static function get_input_cols(): array {
	 ...
	 * @return array<string, string>
	 */
	public static function get_timezone_list( string $selected_regions, string $show_time ): array {
		...
		foreach ( $timezones as $timezone ) {
			try {
				...
				// Skip timezones unsupported by the current PHP/system timezone DB (e.g. America/Ciudad_Juarez on outdated tzdata).
				continue;
			}
		}
		...
		foreach ( $timezone_offsets as $timezone => $offset ) {
			...
			$offset_formatted = gmdate( 'H:i', (int) abs( $offset ) );
			...
			try {
				...
				// Skip timezones unsupported by the current PHP/system timezone DB.
				continue;
			}
	 ...
	 * @return array<string, mixed>
	 */
	public static function get_js_input_vars( WC_Product $product, $args = null ): array {
	 ...
	 * @return string|null
	 */
	public static function tax_label_display(): ?string {
		/*
	 ...
	 */
	public static function all_inputs(): array {
	 ...
	 * @return array<int, array<string, mixed>>
	 */
	public static function get_addons_details(): array {
