	...
	public function get_context( WP_REST_Request $request ) {
		...
		$payload = array(
			...
			'i18n'           => array(
				...
				'legacyEditorHint'   => __( 'Some options are only available in the classic field editor.', 'woocommerce-product-addon' ),
				...
				'unsupportedControl' => __( 'This setting is not editable in the new modal yet.', 'woocommerce-product-addon' ),
				'fallbackSettingsLayout' => __( 'Classic-style settings (full editor coming soon)', 'woocommerce-product-addon' ),
